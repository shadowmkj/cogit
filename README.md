...
Fast, lightweight CLI and TUI tool written in Rust that inspects staged Git diffs and generates **Conventional Commits** using AI (Google Gemini, OpenAI, and Ollama).
...
- **Multiple Providers**: Native support for Google Gemini, OpenAI, and Ollama.
- **Interactive Review & TUI**: Lightweight CLI menu (`inquire`), full visual TUI (`ratatui`), and external `$EDITOR` support.
